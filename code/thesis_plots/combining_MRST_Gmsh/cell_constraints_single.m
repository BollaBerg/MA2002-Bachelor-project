...
circle(constraint_line(2, 1), constraint_line(2, 2), sqrt(0.05^2 + 0.05^2));
circle(constraint_line(1, 1), constraint_line(1, 2), sqrt(0.05^2 + 0.05^2));
circle(0.5, 0.5, sqrt(0.05^2 + 0.05^2));

xlim([0 1]);
ylim([0 1]);
axis("off");
saveas(gcf, "cell_constraints_single.png");
