...
% Gmsh outputs Delaunay triangulation, resulting in "sharper" cells. When converting these to Voronoi, data is lost about the edges of the cells, resulting in loss-of-accuracy regarding constraints (especially face constraints)
